...
<section id="home-section" class="hero">
		          ...
		          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		...
		          		<div class="horizontal">
		          			<h3 class="vr" style="background-image: url({{ asset('assets/images/bg_6.jpg') }});">Stablished Since 2000</h3>
    	...
    	<div class="container">
			...
			@foreach($products as $product)
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="product">
    					<a href="{{ route('productdetail', $product['id']) }}" class="img-prod">
						@if($product->image)
    					...
    					<div class="text py-3 px-3">
							...
							<button class="buy-now text-center py-2" id="buy_now_btn" data-price="{{ $product->price }}" data-id="{{ $product->id }}">Buy now<span><i class="ion-ios-cart ml-1"></i></span></a>
    						</p>
    					</div>
    				</div>
    			</div>
	...
	<script>
		$("#buy_now_btn").on('click', function(e){
			...
			$.ajax({
				url: "{{ route('order_now') }}",
				data: {'_token': "{{ csrf_token() }}", '_mehtod': "GET","product_id": product_id, "price" : price},
